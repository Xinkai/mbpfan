...
#define APPLESMC_PATH "/sys/devices/LNXSYSTM:00/LNXSYBUS:00/PNP0A08:00/device:104/APP0001:00"
...
t_fans *retrieve_fans()
{
    ...
    const char *path_begin = "/sys/devices/LNXSYSTM:00/LNXSYBUS:00/PNP0A08:00/device:104/APP0001:00/fan";
